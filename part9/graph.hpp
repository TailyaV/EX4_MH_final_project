...
public:
    ...
    static Graph buildRandGraph(int numOfEdges, int numOfVartx, int seed); //Build graph with random edges according to a given number ef edges and vertices
     void removeAllEdges(); //Remove all edges of the graph
