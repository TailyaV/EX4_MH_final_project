...
//בגרף מכוון: לכל צומת: מספר קשתות נכנסות = מספר קשתות יוצאות.
// הגרף קשיר חזק  כלומר אפשר להגיע מכל צומת לכל צומת אחר. 
//בגרף לא מכוון: כל הצמתים בדרגה זוגית. הגרף קשיר (כל צומת עם קשת נגיש מכל צומת אחר).
